...
function App() {
  ...
  return(
    <div className="fixed flex flex-row justify-between w-full">
      ...
      <div className={`h-screen w-full my-3  sm:w-full sm:mx-3 sm:mt-16 md:mt-16 md:mx-3 overflow-y-scroll duration-500 ${about? 'filter blur-sm cursor-pointer':''} ${(isOpen)? 'filter blur-sm cursor-pointer':''}`} onClick={() => {
        toggleSidebar(false)
        toggleAbout(false)
        }}>
            <Routes>
