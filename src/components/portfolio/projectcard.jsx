...
const ProjectCard = () => {
    return (
        <div className="w-full">
                <div className=" sm:w-full max-w-screen-xl mx-auto p-5 sm:p-10 md:p-16">

                    <div className="grid grid-cols-2 md:grid-cols-1 sm:grid-cols-1 gap-10">
                        {
                            projectset.map( project => (
                                <div key={project.id} className={`grid2-item rounded mx-auto relative overflow-hidden bg-cover bg-no-repeat transition duration-700 hover:shadow-md hover:shadow-blue-500  ${project.id % 2 == 0 ? 'animate-fadeinbounceright' : 'animate-fadeinbounceleft'}`}>
                                    ...
                                    <div className="relative group rounded-lg -mt-12 px-10 pt-5 pb-5 bg-zinc-900 m-5 transition duration-500  hover:bg-gradient-to-tl hover:from-black hover:to-gray-900">
                                        <a href="#"
